...
// 文件代码目的：这段 Protobuf (annotations.proto) 代码定义了一个 protobuf 扩展 (extension)，用于给 gRPC 方法添加 HTTP 绑定，使得 gRPC 方法可以通过 RESTful API 进行访问。

// 表示该文件使用的是 Protocol Buffers v3 (proto3) 语法，是目前 Google 推荐的版本。
...
var file_google_api_annotations_proto_rawDesc = string([]byte{
	...
	0x42, 0x64, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61,
